...
class TestImageResizerService(MockedEventDrivenServiceStreamTestCase):
    ...
    SERVICE_CLS = ImageResizerService
    ...
    MOCKED_STREAMS_DICT = {
        SERVICE_STREAM_KEY: [],
        'cg-ImageResizerService': MOCKED_CG_STREAM_DICT,
    }

    @patch('image_resizer_service.service.ImageResizerService.process_event_type')
